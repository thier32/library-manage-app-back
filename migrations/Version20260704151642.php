 ...
 */
final class Version20260704151642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE borrow ADD CONSTRAINT FK_55DBA8B070E4FA78 FOREIGN KEY (`member`) REFERENCES `member` (member_id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE borrow ADD CONSTRAINT FK_55DBA8B0CBE5A331 FOREIGN KEY (book) REFERENCES book (book_id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE borrow ADD CONSTRAINT `FK_55DBA8B016A2B381` FOREIGN KEY (book_id) REFERENCES book (book_id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE borrow ADD CONSTRAINT `FK_55DBA8B07597D3FE` FOREIGN KEY (member_id) REFERENCES `member` (member_id) ON UPDATE NO ACTION ON DELETE CASCADE');
